...
for (var i = 0, n = array_length(setting_name); i < n; ++i)
{
	...
	if i == 0
	{
		...
		draw_rectangle(300, dy, 400, dy + 15, false);
		draw_set_color(c_yellow);
		draw_rectangle(300, dy, 300 + audio_get_master_gain(0) * 100, dy + 15, false);
	}
	draw_set_color(c_white);
}
...
if is_setting
{
	setting = Posmod(setting + input_v, array_length(setting_name));
...
draw_cube_width(320,y+100,40-cos(global.timer/35)*10,dsin(global.timer),dcos(global.timer),col,3)
draw_cube_width(320,y+100,20-cos(global.timer/35)*10,dsin(global.timer*1.4),-dcos(global.timer*.6),col,3)
