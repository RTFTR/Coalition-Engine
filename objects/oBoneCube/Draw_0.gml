...
for (var i = 0, n = array_length(edge_list); i < n; i++)
{
	...
	var x1 = vert_list_draw[_prop[0]][0];
	var y1 = vert_list_draw[_prop[0]][1];
	var z1 = vert_list_draw[_prop[0]][2];
	var x2 = vert_list_draw[_prop[1]][0];
	var y2 = vert_list_draw[_prop[1]][1];
	var z2 = vert_list_draw[_prop[1]][2];
	var _bone = _prop[2];
