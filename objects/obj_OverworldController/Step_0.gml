if !audio_group_is_loaded(audiogroup_overworld)
	audio_group_load(audiogroup_overworld);

#region Culling
CullObject(obj_OverworldCollision);
ProcessCulls();
#endregion

#region // Menu lerping
if instance_exists(obj_OverworldCharMain)
{
