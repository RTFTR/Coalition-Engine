...
{
	encounter_soul_x = 	(x - camera_get_view_x(view_camera[0])) * obj_Global.camera_scale_x;
	encounter_soul_y = 	(y - camera_get_view_y(view_camera[0]) - sprite_height / 2) * obj_Global.camera_scale_y;
...
// Menu opening
if global.interact_state == INTERACT_STATE.IDLE and !obj_OverworldController.menu_disable and !obj_OverworldController.dialog_exists
{
	if input_menu // Open Menu, UI works in obj_OverworldController
	{
		...
		var delay = function()
					{
						...
						obj_OverworldController.menu = true;
...
if obj_OverworldController.menu
{
	switch obj_OverworldController.menu_state
	{
		case 0:		//Selection
