...
var CamPos = [camera_get_view_x(view_camera[0]),  camera_get_view_y(view_camera[0])],
	relative_pos = [
		(x - CamPos[0]) * obj_Global.camera_scale_x,
		(y - CamPos[1] - sprite_get_height(sprite_index)/2) * obj_Global.camera_scale_y
	];
...
if encounter_draw[1] draw_sprite_ext(sprite_index, image_index, relative_pos[0], relative_pos[1],
					obj_Global.camera_scale_x, obj_Global.camera_scale_y, image_angle, c_white, 1);
